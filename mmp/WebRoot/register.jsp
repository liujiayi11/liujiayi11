...
<body>
  ...
  <div class="form"  >
      <ul class="tab-group">
        <li class="tab active"><a href="#signup">漫漫注册</a></li>
        &nbsp &nbsp<a href="http://localhost:8080/mmp/login.jsp">返回登陆</a>
      </ul>
 ...
 <div class="field-wrap">
          ...
          <div class="field-wrap">
           ...
           <div class="field-wrap">
            <label>
                         选择头像<span class="req">*</span>
            </label>
            <input type="file" onchange="showimg(this)" name="headimage" required autocomplete="off"/>

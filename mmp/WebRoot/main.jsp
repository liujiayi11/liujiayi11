				...
				<div class="wrap">
					...
					<div class="fr" id="top_nav_right">
						...
						<div class="pop_wrap user_i" style="margin-right:38px">
							<div class="u_nav">
							<a href="http://user.u17.com" class="nav" style="color: #333" target="_blank">个人中心<em></em></a>
							<div class="pop_box right_pop_box" style="display: none;">
								<ul class="pop_box_con usercenter_pop cf">
								<li>
									<a href="http://user.u17.com/favorite/favorite_list_new.php" target="_blank" style="width: 72px;"><span><i>我是读者</i></span></a></li>
								<li>
									<a href="http://comic.user.u17.com" target="_blank" style="width: 72px;"><span><i>我是作者</i></span></a></li>
								</ul>
							</div>
							</div>
						</div>

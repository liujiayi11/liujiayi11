...
<meta charset="UTF-8">
<title>我的书架</title>
<link rel="stylesheet" type="text/css" href="http://static.u17i.com/v2/common/css/common.css?t1535523360"> 
<style>
...
#goTop .btn_goTop span{position:absolute; background:url(http://static.u17i.com/v4/common/images/fixed_right.png) no-repeat; width:50px; height:50px; left:-3px; top:-30px; cursor:pointer}
#goTop .btn_goTop span.h{ background:url(http://static.u17i.com/v4/common/images/fixed_right.png) no-repeat;}
...
<script type="text/javascript" src="http://static.u17i.com/v4/js/u17.js?t1526437697"></script>
<!-- <script type="text/javascript" src="http://static.u17i.com/v4/js/project/www.js?t1484287092"></script> -->
<script src="http://static.u17i.com/v2/js/jquery-tooltip.js" type="text/javascript"></script>
...
<link rel="stylesheet" type="text/css" href="http://static.u17i.com/v4/www/css/bookrack.css?t1530768536">
<script type="text/javascript" src="http://static.u17i.com/v5/js/page/user_center.all.js?t1492149634"></script>
<style type="text/css">
    body {
        padding-top: 47px;
    }
...
<!-- 头部 -->
<script src="http://static.u17i.com/v5/js/page/www.js?t1515655703" type="text/javascript"></script> <script src="http://static.u17i.com/v4/js/project/login_sdo.js" type="text/javascript"></script> <!--[if IE 6]> <script src="http://static.u17i.com/v4/js/DD_belatedPNG_0.0.8a.js" type="text/javascript"></script> <script> DD_belatedPNG.fix(".png24"); </script> <![endif]--> <!--黄色提示框--> <div id="tip_topfixed" style="display:none;top: 46px;margin-left: 113px;"> <a href="javascript:;" class="ico close" title="关闭" onClick="$(this).parent().hide()"></a> <div id="msgview"></div> </div> <!--黄色提示框 end--> <style type="text/css"> #topbar .nav1{background: url(http://static.u17i.com/v4/common/images/cs_topbar.png) no-repeat; padding: 0 16px 0 25px; float: left; height: 44px; font: 14px/44px "Microsoft Yahei";} #topbar .pop_on .nav1{text-decoration:none; color:#fff!important; background-color:#5c5c5c} #tip_topem{display: block!important;} #tip_topclock{display: none!important;} .pd_b_20 { padding-bottom: 20px; } .pd_b_8 { padding-bottom: 8px; } .pd_lf_23 { padding-left: 23px; } .red_e5 { color: #e50000; } .font_30 { font-size: 30px; } .pd_t_8 { padding-top: 8px; } .pd_t_15 { padding-top: 15px; } .reset { width: 68px; height: 25px; height: 23px\9; color: #fff; font-size: 12px; line-height: 25px; line-height: 24px\9; text-align: center; cursor: pointer; overflow: hidden; } .reset{background-position: -250px 2px;background-position: -250px 0\9; color:#444} .reset:hover{color:#444;text-decoration:none} .pd_rt_23 { padding-right: 23px; } .green { color: #6b9812; } #pull_welfare .usercenter_pop li{width: 88px;} #all_msg{height: 18px;line-height: 18px;background-color: #ff0000;border-radius: 5px 5px 0px 5px;font-size: 12px;text-align: center;color: #fff;filter: alpha(opacity=75);-moz-opacity: 0.75;opacity: 0.75;padding: 0 3px;} #all_msg_box{position: absolute;width: 100px;height: 30px;left: 60px;margin-left: -105px;top: -15px;text-align: center;} #pull_welfare_tougao .pop_box_con{border-color: #6dad15;width: 358px;padding: 10px;} #pull_welfare_tougao .pop_box_con strong{font-size: 14px;font-weight: bold;} </style> <div id="topbar"> <div class="topbar_con"> <div class="wrap"> <!--左侧--> <div class="left" id="top_nav"> <!-- 首页 --> <div class="pop_wrap"> <a href="http://www.u17.com/" class="nav1 nav_index" style="color:#333;">首页</a> </div> <!-- 首页 end --> <!--手机版--> <div class="pop_wrap"> <a href="http://www.u17.com/z/app/pc_download/pc_download.html" class="nav nav_app" target="_blank" style="color:#333;">手机版<em></em></a> <div class="pop_box" style="display:none;"></div> </div> <!--手机版 end--> <!--小说--> <div class="pop_wrap" style="display:none;"> <a href="javascript:void(0);" class="nav nav_novel">小说<em></em></a> <div class="pop_box" style="display:none;"></div> </div> <!--小说end--> <!--有熊--> <div class="pop_wrap" style="display:none;"> <a href="javascript:;" class="nav nav_uxiong">有熊<em></em></a> <div class="pop_box" style="display:none;"></div> </div> <!--有熊 end--> <!--游戏--> <div class="pop_wrap"> <a href="http://game.u17.com/" class="nav nav_game" target="_blank" style="color:#333;">游戏<em></em></a> <div class="pop_box" style="display:none;"></div> </div> <!--游戏 end--> </div> <!--左侧 end--> <!--右侧--> <div class="fr" id="top_nav_right"> <!--已登录--> <div id="userbar"></div> <!--已登录 end--> <!--通知--> <div class="pop_wrap"> <a href="javascript:void(0);" class="nav">通知<div class="update_v5Box" id="all_msg_box" style="display:none;"><i class="update_v5" id="all_msg"></i></div><em id="tip_topem"></em><span class="clock" id="tip_topclock" style="display:none;"></span><q>|</q></a> <div class="pop_box"> <ul class="pop_box_con notice_pop cf"> <li><a href="http://user.u17.com/favorite/list.php" target="_blank"><span><i>漫画更新</i><em id="notify_count_favorite_comic_v4" class="f99">0</em></span></a></li> <li><a href="http://user.u17.com/message/system_message_list.php" target="_blank"><span><i>系统消息</i><em id="notify_count_system_message" class="f99">0</em></span></a></li> <!--<li id="author_message_li" style="display:none;"><a href="http://comic.user.u17.com/message/message_list.php" target="_blank"><span><i>作者消息</i><em id="notify_count_author_message" class="f99">0</em></span></a></li>--> <!-- <li><a href="http://user.u17.com/message/message_list.php" target="_blank"><span><i>短消息</i><em id="notify_count_user_message" class="f99">0</em></span></a></li> --> <li><a href="http://user.u17.com/comment/comment.php" target="_blank"><span><i>评论回复</i><em id="msg_reply" class="f99">0</em></span></a></li> <li><a href="http://user.u17.com/message/message_at_list.php" target="_blank"><span><i>@我的消息</i><em id="notify_count_user_message_at" class="f99">0</em></span></a></li> </ul> </div> </div> <!--通知end--> <!--书架--> <div class="pop_wrap" id="index_v4_1_favorite_history"> <a href="http://user.u17.com/favorite/list.php" target="_blank" class="nav">书架<em></em><q>|</q></a> <div class="pop_box"> <div class="pop_box_con book_pop cf"> <div class="tab"> <a href="javascript:;" rel="recent_read" id="tab_recent_read"><i>最近看的漫画</i></a><q></q> <a href="javascript:;" rel="recent_store" id="tab_recent_store" class="curr"><i class="bor_green">我收藏的漫画</i></a> </div> <div class="tab_con"> <!--最近看的漫画--> <div id="recent_read" style="display:none;"><p class="loading"><span></span>正在加载，请稍候……</p></div> <!--最近看的漫画 end--> <!--我收藏的漫画--> <div id="recent_store"><p class="loading"><span></span>正在加载，请稍候……</p></div> <!--我收藏的漫画 end--> </div> </div> </div> </div> <!--书架end--> <!--充值--> <div class="pop_wrap wrap_forum"> <a href="http://pay.u17.com" class="nav nav_pay" target="_blank"><span></span>充值<em></em></a> <div class="pop_box right_pop_box" style="display:none;"> <ul class="pop_box_con usercenter_pop cf"> <li><a href="http://pay.u17.com/vip_member" target="_blank"><span><i>VIP充值</i></span></a></li> <li><a href="http://pay.u17.com" target="_blank"><span><i>妖气币充值</i></span></a></li> </ul> </div> </div> <!--充值 end--> <!-- 论坛 --> <!-- <div class="pop_wrap wrap_forum"><a href="http://bbs.u17.com/" target="_blank" class="fl nav right_choose">论坛</a></div> --> <!-- 论坛 end --> <!-- 作者福利 --> <div class="pop_wrap pull_box wrap_welfare" id="pull_welfare"> <a href="javascript:void(0);" target="_blank" class="fff nav fl right_choose">作者福利<em></em><q>|</q></a> <div class="pop_box right_pop_box" style="display:none;"> <ul class="pop_box_con usercenter_pop cf"> <li><a href="http://www.u17.com/z/zt/2018_mhds3_pc/index.html" target="_blank"><span>漫画大赛</i></span></a></li> <li><a href="http://www.u17.com/z/zt/zhexian/" target="_blank"><span><i>月票折现</i></span></a></li> <li><a href="http://www.u17.com/z/zt/shouyi/" target="_blank"><span>月票排名奖</i></span></a></li> <li><a href="http://daxue.u17.com/" target="_blank"><span>有妖气大学</i></span></a></li> <li><a href="http://www.u17.com/dream/" target="_blank"><span>梦想激励</i></span></a></li> </ul> </div> </div> <!-- 作者福利 end --> <!-- 投稿签约 --> <div class="pop_wrap pull_box wrap_welfare" id="pull_welfare_tougao"> <a href="javascript:void(0);" target="_blank" class="fff nav fl right_choose">投稿签约<em></em><q>|</q></a> <div class="pop_box" style="display: none;"><div class="pop_box_con"><strong>你想成为有妖气的签约作者吗？那就快快给我们投稿吧！</strong><br/> 投稿需准备——<br/> （1）、故事大纲包括主线剧情间断性发展，起承转合。<br/> （2）、本作品3、4个人设，人设要全身画到脚和鞋子。<br/> （3）、往期作品。（没有可忽略~）<br/> （4）、投稿作品的第一话分镜草图（至少10页连贯分镜）. 以及2-4张完成稿。<br/> <strong>以上文件整理打包，发送至u17投稿邮箱:comic@u17.com</strong></div></div> </div> <!-- 投稿签约 end --> <!--上传漫画--> <div class="pop_wrap"> <a href="http://comic.user.u17.com/comic/comic_add.php" class="nav nav_upload" target="_blank">上传漫画</a> </div> <!--上传漫画 end--> </div> <!--右侧end--> </div> </div> </div> <script> set_client_width_class(); flush_login(); $.xtab({ tab: '#top_nav .nav', body: '#top_nav .pop_box', tab_show_class: 'cur', tab_hide_class: '', event: 'mouseover', lazy_time: 200, default_tab: 6, callback: function(tab, body, flag) { if (body.html() == '' && flag != 7) { $.ajax({ url: '/z/fp/index_inc_v4_1/index_nav_' + flag + '.html', dataType: 'text', type: 'get', success: function(html) { body.html(html); }, error: function() { showMsg('通讯错误'); } }); } } }); $.xtab({ tab: '#top_nav_right .right_nav', body: '#top_nav_right .right_pop_box', tab_show_class: 'cur', tab_hide_class: '', event: 'mouseover', lazy_time: 200, default_tab: 3, callback: function(tab, body, flag) { if (body.html() == '' && flag != 7) { $.ajax({ url: '/z/fp/index_inc_v4_1/index_nav_right_' + flag + '.html', dataType: 'text', type: 'get', success: function(html) { body.html(html); }, error: function() { showMsg('通讯错误'); } }); } } }); $(document).ready(function(){ /* *为书架绑定鼠标事件(ajax触发,只调取一次) */ /*获取我收藏的漫画*/ $("#index_v4_1_favorite_history").bind('mouseenter',get_favorite_comic_list); /*获取我阅读的漫画*/ $("#index_v4_1_favorite_history").bind('mouseenter', get_read_comic_list); /*导航下拉*/ index_pop_wrap(); /*书架背景变色*/ index_bookList(); /*tab切换*/ $("#index_v4_1_favorite_history .tab a").mouseover(index_tab); /*传送门展开收缩*/ index_portal(); }); $("#pull_welfare").bind("mouseenter",function() { $(this).addClass("pop_on"); }); $("#pull_welfare_tougao").bind("mouseenter",function() { $(this).addClass("pop_on"); }) </script><div class="br-header">
    <a target="_blank" href="http://www.u17.com/click/1_99_41694.html" class="ad-img" style="background: url(http://image.mylife.u17t.com/2019/01/30/1548836204_d1hcMsTl1L4d.jpg) center top no-repeat;">
        <span></span>
    </a>
</div> 
<!-- 工具条 -->
    ...
    <div class="bri-tools">
        ...
        <div class="bri-tools-detail">
            ...
            <div class="bri-tools-list">
                <li>
                    <a href="self.jsp"><i class="left-arrow"></i>个人设置<i class="right-arrow"></i></a>
                </li>
                <!-- <li>
...
<div class="bri-sidebar">
    ...
    <div class="bri-main">
        ...
        <div class="bri-main-nav">
            ...
            <span class="bmn-link">
                <a href="http://comic.u17.com/rank/" target="_blank">不知道还有哪些好作品？去看看排行榜吧</a>
            </span>
        </div>
        <!-- 导航 end -->
        <!-- 加载中 -->
        <div class="zp-empty" id="loading" style="display: block; position: absolute; top: 36px; left: 50%; margin-left: -32px;">
            <img src="http://static.u17i.com/v4/www/images/bookrack/empty_yaoqiniang.png" />
            <span>加载中···</span>
        </div>
        <!-- 加载中 end -->
...
<div id="alert_sel_group" onclick="stop_propagation(event)">
    ...
    <div class="creat_box" id="select_favorite_group_add">
        ...
        <div style="display:none; margin-top:10px">
            <input type="text" class="group_name text" value="请输入分组名称，最多8个字" onclick="if(this.value=='请输入分组名称，最多8个字')this.value=''" onfocus="$(this).css('color','#333');" onblur="$(this).css('color','#ccc')" color="1"/>
            ...
            <input type="button" class="btn" value="" onclick="select_add_group('#select_favorite_group_add')"/>
...
<div id="form_add_group">
    <div class="row">
      <label><i class="red_f0">*</i>分组名：</label>
        <input type="text" class="text" id="favorite_group_name" value="请输入分组名称，最多8个字" onclick="if(this.value=='请输入分组名称，最多8个字')this.value=''" onkeydown="if(this.value=='请输入分组名称，最多8个字')this.value=''" color="" /></div>
...
<div id="form_manage_group">
    ...
    <div class="creat_box" id="manage_favorite_group_add">
        ...
        <div style="margin-top: 10px;display:none">
            <input type="text" value="请输入分组名称，最多8个字" onclick="if(this.value=='请输入分组名称，最多8个字')this.value=''" onfocus="$(this).css('color','#333');" onblur="$(this).css('color','#ccc')" class="group_name text" color="1">
            <span class="choose_col col1" onmouseover="show_color_options(this,'0',event)" onmouseout="hide_color_options(this,'0',event)">
                <div class="col_box" style="display:none;" onmouseover="show_color_options(this,1,event)" onmouseout="hide_color_options(this,1,event)">
                    <em></em>
          ...
          <input type="button" value="" class="btn" onclick="select_add_group('#manage_favorite_group_add')">
...
<script type="text/javascript" src="http://static.u17i.com/v4/js/bookrack.js?t1534144758&99996989898"></script>
<script type="text/javascript">
//选择颜色
...
function append_group_display( group_id , group_name, color, group_sort){
    ...
    //管理分组列表加一个
    $('#manage_favorite_group_list').append('<div class="group" group-id="'+group_id+'" onmouseover="$(this).addClass(\'bg_hover\');$(this).find(\'a.edit\').show();" onmouseout="$(this).removeClass(\'bg_hover\');$(this).find(\'a.edit\').hide();"><p class="p_group_name" style="display: block;"><span>'+group_name+'</span><a class="edit" href="javascript:;" onclick="select_group_edit(this, event)">编辑</a></p><div class="edit_con" style="display:none"><input type="text" value="'+group_name+'" class="group_name text" ori-value="'+group_name+'" ori-color="'+color+'" color="'+color+'" sort="'+group_sort+'"  /><span class="choose_col col'+color+'" onmouseover="show_color_options(this,\'0\',event)" onmouseout="hide_color_options(this,\'0\',event)"><div class="col_box" style="display:none" onmouseover="show_color_options(this,1,event)" onmouseout="hide_color_options(this,1,event)"><em></em><a class="col1" href="javascript:;" onclick="select_group_color1(1, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col2" href="javascript:;" onclick="select_group_color1(2, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col3" href="javascript:;" onclick="select_group_color1(3, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col4" href="javascript:;" onclick="select_group_color1(4, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col5" href="javascript:;" onclick="select_group_color1(5, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col6" href="javascript:;" onclick="select_group_color1(6, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col7" href="javascript:;" onclick="select_group_color1(7, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col8" href="javascript:;" onclick="select_group_color1(8, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col9" href="javascript:;" onclick="select_group_color1(9, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a><a class="col10" href="javascript:;" onclick="select_group_color1(10, $(\'#manage_favorite_group_list .group[group-id='+group_id+']\'))"><span></span></a></div></span><i class="delete" onclick="delete_group('+group_id+')"></i><div class="clear_both"><a class="save" href="javascript:;" onclick="edit_group( '+group_id+' )">保存</a><a class="cancel" href="javascript:;" onclick="$(this).parent().parent().hide().prev().show();">取消</a></div></div></div>');

...
<link href="http://static.u17i.com/v2/common/css/common.css?t1535523360" rel="stylesheet" type="text/css" />
...
<script src="http://static.u17i.com/v4/js/u17.js?t1526437697" type="text/javascript"></script>
...
//填写生日
$(function(){ $('#birthday').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'yy-mm-dd',defaultDate:'1999-02-21',minDate:'1900-01-01',maxDate:'2019-02-16'});});
                    ...
                    <div class="mg_2 pd_t_20">
                        ...
                        <!-- <div class="pd_t_10"> -->
                            ...
                            <form method="POST" name="profile_form" id="profile_form">
                                <!-- 昵称 -->
                                    ...
                                    <div class="clearfix" style="padding:10px 30px;">
                                        ...
                                        <div class="line">    
                                            ...
                                            <input type="text" value="" class="input_txt_210 ve_m" name="new_nickname" id="dialog_vip_nickname">    
                                            <p class="tip" style="color: #666666;padding: 6px 0 0 37px;">昵称的长度为6个汉字或12个字符。
                                                <span class="ico_error" style="display:none;"></span>    
                                                                ...
                                                                <!-- 真实姓名 -->
                                <div class="pd_tb_8 bg_bottom auto zoom"><span class="rt"><select class="select_1" name="realname_secret"><option value="Y" >私密</option><option value="N" >公开</option></select></span><span class="lf line_18_22 pd_rt_23">真<i>实</i><i>姓</i>名:</span><input type="text" class="input_txt_210 lf" id="realname" name="realname" value=""/></div>

                                <!-- 性别 -->
                                <div class="pd_tb_8 bg_bottom auto zoom"><span class="rt"><select class="select_1" name="sex_secret"><option value="N" >公开</option><option value="Y" >私密</option></select></span><span class="lf pd_rt_23">性　　　别:</span><input type="radio" class="radio" name="sex" value="男"  /><span class="lf pd_rt_23">男</span><input type="radio" class="radio" name="sex" value="女"  /><span class="lf">女</span><input type="radio" class="radio" name="sex" value="保密" checked/></div>
                                ...
                                <input type="text" class="input_txt_210 lf" id="birthday" name="birthday" value="" />
                                ...
                                <dd class="lf">
                                                                        <input type="text" class="input_txt_210 lf" id="mobile" name="mobile" value=""/>
                                                                        <span class="lf"></span>
                                    <input class="lf" name="hiddenField" type="hidden" id="hiddenField" value="60"/>
                                </dd>
                                ...
                                <dl class="pd_tb_8 auto zoom" id="pos_email">
                                    ...
                                    <dd class="lf">
                                                                                <input type="text" class="input_txt_210 lf" id="email" name="email" value="" />
                                                                            </dd>
                                ...
                                <!-- QQ -->
                                <dl class="pd_tb_8 bg_bottom auto zoom"><dt class="rt"><select class="select_1" disabled="disabled"><option value="Y">私密</option></select></dt><dd class="lf line_18_22 pd_rt_23">　　　 QQ:</dd><dd class="lf"><input type="text" class="input_txt_210 lf" id="qq" name="qq" value=""/><span></span></dd></dl>

                                <!-- 所在地区 -->
                                <div class="pd_tb_8 bg_bottom auto zoom"><span class="rt"><select class="select_1" name="province_secret"><option value="N" >公开</option><option value="Y" >私密</option></select></span><span class="lf line_18_22 pd_rt_23">所<i>在</i><i>城</i>市:</span><select class="select_80" name="province" id="select_province"><option value="">省/直辖市</option></select>&nbsp;<select name="city" class="select_80" id="select_city"><option value="">城市/地区</option></select></div>

                                <!-- 邮编 -->
                                <dl class="pd_tb_8 bg_bottom auto zoom"><dd class="rt"><select class="select_1" disabled="disabled"><option value="Y">私密</option></select></dd><dt><dd class="lf line_18_22 pd_rt_23">邮　　　编:</dd><dd class="lf"><input type="text" class="input_txt_210 lf" id="zipcode" name="zipcode" value=""/><span></span></dd></dl>

                                <!-- 地址 -->
                                <dl class="pd_tb_8 auto zoom"><dt class="rt"><select class="select_1" disabled="disabled"><option value="Y">私密</option></select></dt><dd class="lf line_18_22 pd_rt_23">地　　　址:</dd><dd class="lf"><input type="text" class="input_txt_210 lf" id="address" name="address" value=""/></dd></dl>
                                ...
                                <div class="mg_lf_90 width_520 auto zoom"><span class="rt gray_9c">你还可以输入<font class="red_e5">300</font>字</span><span class="lf mg_t_1"><input type="submit" class="btn submit" value="保存" />&nbsp;<input type="reset" class="btn reset" value="重置" /></span></div>
                            </form>
                        </div>
                    </div>
...
<div id="ft" class="UT_space_footer">
    <div class="ft bg_white">
        <div class="ft_rt rt txt_rt"><span class="gray">Copyright©2005-2017 Thunder </span><a class="blue unline" href="http://www.u17.com" target="blank">版权所有</a><br>京ICP证：120807号</div>
        <div class="ft_lf"><a class="gray" href="http://www.u17.com" target="blank">首页</a> | <a class="gray" href="http://www.u17.com/z/help/about_intro.html" target="blank">关于Thunder</a> | <a class="gray" href="http://www.u17.com/z/help/faq.html" target="blank">帮助中心</a> | <a class="gray" href="http://www.u17.com/feedback/problem.php" target="blank">意见反馈</a> | <a class="gray" href="http://www.u17.com/comment/2.html" target="blank">不良信息举报</a><br>&nbsp;<!-- Processed in 36.71 ms querys:0 --></div>
    </div>
</div>
<!--footer结束-->
